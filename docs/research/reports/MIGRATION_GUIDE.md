...
This guide helps you upgrade from the previous `java-maven-template` to **JOTP (Java OTP Framework)** v1.0.0 and beyond.
...
JOTP implements all 15 Erlang/OTP primitives in Java 26:
- **Processes**: Lightweight virtual-thread processes with mailboxes (`Proc<S,M>`)
- **Supervisors**: Hierarchical process supervision with restart strategies
- **State Machines**: Complex workflows with sealed transitions
- **Event Management**: Typed event broadcasting
...
- **Java version requirement**: Java 26 with preview features mandatory
- **Documentation restructuring**: Diataxis-based documentation system
...
**New Requirement**: Java 26+ with preview features enabled

JOTP now requires Java 26 with mandatory preview features:
...
### 5. Module System Enforcement

JPMS module system is now enforced. No classpath fallback available.
...
```bash
find src -name "*.java" -type f -exec sed -i '' 's/org\.acme\./io.github.seanchatmangpt.jotp./g' {} +
```
...
### Step 4: Update Maven Compiler Configuration

Ensure your Maven compiler plugin enables Java 26 preview features:
...
- **Reference**: See the [API Documentation](../reference/api.md) for complete API details
- **How-To Guides**: Check [docs/how-to/](../how-to/) for common patterns
- **Tutorials**: Start with [docs/tutorials/getting-started.md](../tutorials/getting-started.md)
- **Explanations**: Read [docs/explanations/](../explanations/) for deep dives
...
- Review [Common Patterns](../how-to/common-patterns.md)
...
- **Maven Central**: https://central.sonatype.com/artifact/io.github.seanchatmangpt/jotp
- **Java 26 Documentation**: https://openjdk.org/projects/jdk/26/
- **Erlang/OTP Principles**: http://erlang.org/doc/

---

**Document Version:** 1.0.0
**Last Updated:** 2026-03-15
**Maintained By:** JOTP Project Team
