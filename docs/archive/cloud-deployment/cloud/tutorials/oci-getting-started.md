...
This tutorial guides you through deploying your **JOTP** application to Oracle Cloud Infrastructure (OCI) using Packer and Terraform.

> **Note:** OCI deployment is currently in beta. The infrastructure has been tested but may require additional validation for production use.
