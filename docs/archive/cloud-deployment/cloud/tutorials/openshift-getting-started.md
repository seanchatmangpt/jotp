...
This tutorial has been archived. See [OpenShift Getting Started (Archived)](../archived/openshift/openshift-getting-started.md) for documentation provided for future implementation and community contribution.

> **⚠️ Important:** OpenShift deployment is not currently supported. The infrastructure code referenced in this guide does not yet exist. See [Cloud Deployment Status](../status.md) for details.
...
namespace            = "jotp-app"
app_name             = "jotp"
image                = "image-registry.openshift-image-registry.svc:5000/jotp-app/jotp:latest"
replicas             = 1
```
...
oc new-app --name jotp \
  --docker-image=image-registry.openshift-image-registry.svc:5000/jotp-app/jotp:latest
