...
This tutorial guides you through deploying your **JOTP** application to Microsoft Azure using Packer and Terraform.

> **Note:** Azure deployment is currently in beta. The infrastructure has been tested but may require additional validation for production use.
