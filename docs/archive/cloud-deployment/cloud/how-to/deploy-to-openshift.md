...
This guide has been archived. See [OpenShift Deployment (Archived)](../archived/openshift/deploy-to-openshift.md) for documentation provided for future implementation and community contribution.
