---
title: "Migrating from Erlang/OTP"
description: "Comprehensive guide for Erlang developers moving to JOTP"
---
...
<Tabs items={['Erlang gen_server', 'JOTP Proc with handler', 'JOTP GenServer subclass']}>
  <Tab>
    ```erlang
...
<Tabs items={['Erlang gen_statem', 'JOTP StateMachine']}>
  <Tab>
    ```erlang
    -module(code_lock).
...
<Tabs items={['Erlang', 'JOTP']}>
  ...
  <Tab>
    ...
    var conn2 = pool.startChild();  // Creates "conn-2"
    ```
  </Tab>
</Tabs>
...
|-----------|------------|---------------|
| Basic process migration | Medium | 2-3 weeks |
| gen_server patterns | Medium | 2-3 weeks |
| gen_statem workflows | High | 3-4 weeks |
| Supervisor trees | Medium | 2-3 weeks |
| Process registry | Low | 1 week |
| Event handlers | Low | 1-2 weeks |
| Testing & validation | Medium | 2-3 weeks |
| **Total** | | **8-10 weeks** |
...
- Run Erlang and JOTP versions side-by-side
...
- [Erlang-Java Mapping](/docs/explanations/erlang-java-mapping)
- [OTP Equivalence Proof](/docs/explanations/otp-equivalence)
