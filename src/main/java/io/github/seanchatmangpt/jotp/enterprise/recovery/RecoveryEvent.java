 ...
 *
 * Broadcast via EventManager to track retry attempts and outcomes.
 */
public sealed interface RecoveryEvent permits
  ...
  record AttemptFailed(String taskName, int attemptNumber, String error, Duration duration, long timestamp)
      implements RecoveryEvent {}
