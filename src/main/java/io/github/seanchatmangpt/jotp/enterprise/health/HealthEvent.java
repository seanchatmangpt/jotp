 ...
 *
 * Broadcast via EventManager when health status changes occur.
 */
public sealed interface HealthEvent permits
    HealthEvent.HealthCheckStarted,
  ...
  record StatusTransition(
      String service, HealthStatus from, HealthStatus to, long timestamp)
      implements HealthEvent {}
