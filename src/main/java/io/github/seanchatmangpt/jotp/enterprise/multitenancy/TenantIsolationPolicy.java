 ...
 *
 * Defines how tenants are isolated from each other in the supervisor hierarchy.
 */
public sealed interface TenantIsolationPolicy permits
    TenantIsolationPolicy.Strict,
