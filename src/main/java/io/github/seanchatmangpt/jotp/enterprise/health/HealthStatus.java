 ...
 *
 * Used by HealthCheckManager to track transitions: Healthy → Degraded → Unhealthy.
 * Each status provides exhaustiveness checking via pattern matching in Java 26.
 */
