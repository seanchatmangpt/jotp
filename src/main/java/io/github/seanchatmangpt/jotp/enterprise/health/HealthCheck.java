 ...
 *
 * Health checks are non-invasive probes of service health. They can be synchronous or
 * asynchronous and should not kill the target service if they fail.
 */
public sealed interface HealthCheck permits
   ...
   *
   * Implemented via ProcessMonitor to detect process crashes without killing the target.
   */
   ...
   *
   * Typically involves sending a test request and validating response.
   */
   ...
   *
   * Can query service state via ProcSys without stopping it.
   */
