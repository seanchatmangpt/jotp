...
public class GenServerExample {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        CompletableFuture<CounterState> result1 =
        ...
        CompletableFuture<CounterState> result2 =
                counterService.ask(new CounterMessage.IncrementBy(3), timeout);
        CounterState state2 = result2.join();
        System.out.println("   Response: count = " + state2.count());

        // Request 3: Get current count
        System.out.println("\n4. Sending: GetCount()");
        CompletableFuture<CounterState> result3 =
                counterService.ask(new CounterMessage.GetCount(), timeout);
        ...
        CompletableFuture<CounterState> result4 =
                counterService.ask(new CounterMessage.IncrementBy(2), timeout);
        ...
        CompletableFuture<CounterState> finalCheck =
                counterService.ask(new CounterMessage.GetCount(), timeout);
