 ...
 * and how the {@link ParameterDataAccess} process retrieves data via {@code GetNextSamples/GoTo}.
 *
 * <ul>
 *   <li>{@code Periodic} — fixed-rate sample stream from a continuously running ECU function (e.g.
 *       1 kHz throttle position).
