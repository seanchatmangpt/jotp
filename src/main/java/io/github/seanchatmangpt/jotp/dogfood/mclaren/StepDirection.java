...
/**
 * Sample retrieval direction — mirrors {@code
 * MESL.SqlRace.Domain.Infrastructure.Enumerators.StepDirection}.
 *
 ...
 * Analysts use {@code Reverse} when replaying telemetry from a lap boundary back toward the session
 * start (e.g. to compute braking events working backward from the apex).
 */
