 ...
 *
 * <p>Enterprise Integration Pattern: <em>Resequencer</em> (EIP §8.7). Buffers out-of-order
 * messages by sequence number and dispatches them in order when a contiguous sequence is available.
 *
...
public final class Resequencer<T> {
    ...
    private record State<T>(
            Map<String, TreeMap<Integer, T>> buffers,
            Map<String, Integer> expectedNext) {}
