...
public class RoutingPatternsDemo {
    ...
    private static void demonstrateDynamicRouter() {
        ...
        Proc<List<String>, String> orderProc =
                new Proc<>(
                        orderService,
                        (state, msg) -> {
                            state.add("[ORDER] " + msg);
        ...
        router.registerHandler(
                "order-service", msg -> System.out.println("  [BEFORE ROUTE] Order: " + msg));
        router.registerHandler(
                "payment-service", msg -> System.out.println("  [BEFORE ROUTE] Payment: " + msg));
        router.registerHandler(
                "shipping-service", msg -> System.out.println("  [BEFORE ROUTE] Shipping: " + msg));
    ...
    private static void demonstrateRecipientListRouter() {
        ...
        var sv2 = new Supervisor(Supervisor.Strategy.ONE_FOR_ONE, 5, Duration.ofSeconds(60));
        ...
        System.out.println(
                "  Notification Service received: " + notificationMessages.size() + " events");
