 ...
 *
 * <p>Demonstrates safe message deduplication in a payment system: - Client sends payment
 * confirmation - Network duplicates the same confirmation message - Receiver detects duplicate and
 * safely ignores it - No double-charging occurs
 *
 * <p>Also demonstrates: - Fresh message processing - Duplicate detection - Statistics tracking -
...
public class IdempotentReceiverExample {
    ...
    static class PaymentProcessor {
        private final ConcurrentHashMap<String, Double> processedPayments =
