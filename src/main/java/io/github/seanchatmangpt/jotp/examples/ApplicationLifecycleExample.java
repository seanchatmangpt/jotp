...
public class ApplicationLifecycleExample {
  ...
  public static class MyChannelApp implements Application {
    ...
    public Result<ProcRef<?>, Exception> start(StartType type, Object... args) {
      try {
        ...
        int maxChannels =
            (Integer) config.env().getOrDefault("max_channels", 100);
  ...
  public static class ChannelPool {
    ...
    public Result<String, Exception> allocateChannel() {
      ...
      return Result.failure(
          new Exception("Channel pool exhausted: " + activeChannels.get() + "/" + maxChannels));
    }
  ...
  public static class ApplicationLifecycleManager {
     ...
     */
    public static Result<Void, String> startApplication(ApplicationConfig config, StartType type) {
      try {
        ...
        if (startResult.isFailure()) {
          return Result.failure("Application startup failed: " + startResult.failureReason());
        }
    ...
    public static class Builder {
      ...
      public ApplicationConfig build() {
        return new ApplicationConfig(
            name, version, description, modules, registeredNames, dependencies, mod, env);
      }
    }
  }
  ...
  public static void main(String[] args) {
    System.out.println("╔═══════════════════════════════════════════════════════════════════════════╗");
    System.out.println("║  Application Lifecycle Example: Complete JOTP Application Demonstration  ║");
    System.out.println("╚═══════════════════════════════════════════════════════════════════════════╝\n");
    ...
    LOG.info("  Config accessible from application: {}", ApplicationConfig.getCurrent() != null);
    System.out.println();
    ...
    System.out.println("╔═══════════════════════════════════════════════════════════════════════════╗");
    System.out.println("║  ✅ Application Lifecycle Example Complete                               ║");
    System.out.println("║                                                                           ║");
    System.out.println("║  Demonstrated Concepts:                                                  ║");
    System.out.println("║  • Application Callback Interface (start/stop)                            ║");
    System.out.println("║  • Supervision Tree Creation                                              ║");
    System.out.println("║  • ApplicationConfig Builder Pattern                                      ║");
    System.out.println("║  • Environment Configuration Management                                   ║");
    System.out.println("║  • Application Lifecycle: Load → Start → Stop → Unload                    ║");
    System.out.println("║  • StartType Enumeration (NORMAL, TAKEOVER, FAILOVER)                     ║");
    System.out.println("║  • Worker Process Management                                              ║");
    System.out.println("║  • RestartPolicy Integration (ONE_FOR_ONE)                                ║");
    System.out.println("╚═══════════════════════════════════════════════════════════════════════════╝");
  }
