...
public class DistributedPaymentProcessing {
  ...
  public static class NotificationService {
    public Result<String, Exception> sendConfirmation(PaymentData payment, String transactionId) {
      return Result.of(
          () -> {
  ...
  public static void main(String[] args) {
    System.out.println("╔═══════════════════════════════════════════════════════════════════════════╗");
    System.out.println("║  Distributed Payment Processing: JOTP Cross-JVM Example                 ║");
    System.out.println("╚═══════════════════════════════════════════════════════════════════════════╝\n");
    ...
    System.out.println("Processing " + payment1.paymentId() + " (Amount: $" + payment1.amount() + ")");
    ...
    System.out.println("Processing " + payment2.paymentId() + " (Amount: $" + payment2.amount() + ")");
    ...
    System.out.println("Payment Gateway Circuit Breaker: " + coordinator.getGatewayCircuitState());
