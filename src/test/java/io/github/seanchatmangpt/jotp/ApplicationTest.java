 ...
 *
 * <p>Tests cover application lifecycle management, startup sequence, service registration,
 * graceful shutdown, and hook execution.
 *
...
class ApplicationTest {
  ...
  void testStartupSequence() throws Exception {
    ...
    var app = Application.builder("test-app") //
        .init(() -> {
  ...
  void testServiceLookup() throws Exception {
    ...
    var handler = (Integer state, TestMessage msg) -> {
  ...
  void testBuilderPattern() throws Exception {
    ...
    var app = Application.builder("my-service") //
