 ...
 *
 * <ul>
 *   <li>Throughput (messages/second)
 *   <li>Latency percentiles (p50, p95, p99)
 *   <li>GC impact and memory usage
 *   <li>Virtual thread pinning duration
 * </ul>
 *
 * <p>Uses Java 26 reflection API for JFR integration and memory profiling.
 */
public class PerformanceMetricsExtension
        implements TestInstancePostProcessor, TestExecutionExceptionHandler {
