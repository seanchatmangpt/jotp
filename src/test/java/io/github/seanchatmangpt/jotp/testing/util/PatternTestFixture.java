 ...
 *
 * <ul>
 *   <li>Enumerate sealed Message type variants
 *   <li>Create test instances for each variant
 *   <li>Auto-cleanup processes and deregistration
 *   <li>Manage process lifecycle
 * </ul>
 *
 * <p>Usage:
 *
 * <pre>{@code
 * var fixture = PatternTestFixture.of(ContentBasedRouter.class)
...
public class PatternTestFixture<P> {
    ...
    public static <P> PatternTestFixture<P> of(Class<P> patternClass) {
    ...
    public PatternTestFixture<P> build() {
        try {
            ...
            throw new IllegalStateException(
                    "Failed to create fixture for " + patternClass.getName(), e);
        }
        return this;
    }
    ...
    public String toString() {
        return "PatternTestFixture[pattern="
