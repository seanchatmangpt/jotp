 ...
 *
 * <ul>
 *   <li>Message causality chains (request → routing → reply)
 *   <li>No "orphaned" messages (unmatched correlation IDs)
 *   <li>Distributed tracing headers (request, reply, trace IDs)
 * </ul>
 *
...
public class CorrelationTrackingExtension implements TestInstancePostProcessor, ParameterResolver {
    ...
    public static class CorrelationTracker {
        ...
        public void recordStep(String correlationId, String stepName) {
            ...
            correlationChains
                    .computeIfAbsent(
                            correlationId, k -> Collections.synchronizedList(new ArrayList<>()))
                    .add(stepName);
