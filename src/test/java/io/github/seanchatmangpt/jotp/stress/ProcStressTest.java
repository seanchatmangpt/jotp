 ...
 * ramp, spike). Measures throughput, latency percentiles, and identifies breaking points where
 * the mailbox becomes saturated.
 */
...
class ProcStressTest extends StressTestBase {
  ...
  void testRampLoad() {
    ...
    try {
      LoadProfile profile =
          new LoadProfile.RampLoad(1_000L, 10_000L, Duration.ofSeconds(10));
      MetricsCollector metrics =
          runStressTest(
  ...
  void testSaturation() {
    ...
    try {
      ...
      LoadProfile profile =
          new LoadProfile.ConstantLoad(100_000L, Duration.ofSeconds(5));
  ...
  void testConcurrentSenders() {
    ...
    try {
      ...
      LoadProfile profile =
          new LoadProfile.ConstantLoad(totalLoad, Duration.ofSeconds(5));
