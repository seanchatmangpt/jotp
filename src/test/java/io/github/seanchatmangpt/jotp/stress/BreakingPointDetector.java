 ...
 *
 * <ul>
 *   <li>Throughput drops >10% from peak
 *   <li>Latency p99 exceeds threshold (e.g., 10ms for 1M msg/sec nominal)
 *   <li>Error rate exceeds threshold (e.g., >0.1%)
 *   <li>Heap pressure reaches critical level (e.g., >90% heap used)
 * </ul>
 */
public final class BreakingPointDetector {
    ...
    public boolean detect(MetricsCollector metrics) {
        ...
        if (latencyP99 >= latencyThresholdMs) {
            ...
            breakingPointReason =
                    String.format(
                            "Latency p99 exceeded threshold: %.2f ms >= %.2f ms",
                            latencyP99, latencyThresholdMs);
            return true;
        }
        ...
        if (errorRate >= errorRateThreshold) {
            ...
            breakingPointReason =
                    String.format(
                            "Error rate exceeded threshold: %.2f%% >= %.2f%%",
