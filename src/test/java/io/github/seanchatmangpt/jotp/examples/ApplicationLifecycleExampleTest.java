...
class ApplicationLifecycleExampleTest {
  ...
  class IntegrationTests {
    ...
    void testStartTypeVariants() {
      ...
      // Act
      var normalResult = ApplicationLifecycleManager.startApplication(config, StartType.NORMAL);
      ApplicationLifecycleManager.stopApplication(config);
      ...
      var failoverResult = ApplicationLifecycleManager.startApplication(config, StartType.FAILOVER);
      ApplicationLifecycleManager.stopApplication(config);
