 ...
 *
 * <p>Run with: java --enable-preview -cp target/classes ObservabilityPrecisionRunner
 */
public class ObservabilityPrecisionRunner {
    ...
    public static void main(String[] args) {
        ...
        FrameworkEventBus.FrameworkEvent.ProcessCreated sampleEvent =
                new FrameworkEventBus.FrameworkEvent.ProcessCreated(Instant.now(), "bench-proc-1", "Proc");
        ...
        System.out.println("Iterations: " + iterations);
        System.out.println("Total time: " + ((enabledEmptyEnd - enabledEmptyStart) / 1_000_000) + " ms");
        ...
        System.out.println("Iterations: " + iterations);
        System.out.println("Total time: " + ((enabledSubEnd - enabledSubStart) / 1_000_000) + " ms");
        ...
        for (int i = 0; i < iterations; i++) {
            events.add(new FrameworkEventBus.FrameworkEvent.ProcessCreated(
        ...
        System.out.println("Iterations: " + iterations);
        System.out.println("Total time: " + ((eventCreateEnd - eventCreateStart) / 1_000_000) + " ms");
        System.out.println("Average event creation: " + String.format("%.2f", eventCreateAvg) + " ns/op");
        System.out.println();
        ...
        System.out.println();
        System.out.println("Metric                                                                   (ns/op)");
        System.out.println("=========================================================================");
        System.out.printf("EventBus.publish (disabled, no subscribers)                        %8.2f%n", disabledAvg);
        System.out.printf("EventBus.publish (enabled, no subscribers)                         %8.2f%n", enabledEmptyAvg);
        System.out.printf("EventBus.publish (enabled, one subscriber)                         %8.2f%n", enabledSubAvg);
        System.out.printf("Proc.tell() (observability disabled)                              %8.2f%n", procTellAvg);
        System.out.printf("ProcessCreated event allocation                                    %8.2f%n", eventCreateAvg);
        System.out.printf("Baseline empty method                                              %8.2f%n", baselineAvg);
        System.out.println("=========================================================================");
        System.out.println();
        ...
        System.out.println("EventBus overhead over baseline: " + String.format("%.2f", pureEventBusOverhead) + " ns");
        System.out.println("Proc.tell() overhead over baseline: " + String.format("%.2f", tellOverhead) + " ns");
        System.out.println();
        ...
        System.out.println("EventBus overhead as % of baseline: " + String.format("%.2f", eventBusOverheadPct) + "%");
        System.out.println("Proc.tell() overhead as % of baseline: " + String.format("%.2f", tellOverheadPct) + "%");
        System.out.println();
